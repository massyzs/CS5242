...
def plot_distribution(embedded_data, labels, title, ax):
    for label in np.unique(labels):
        ...
        ax.scatter(embedded_data[indices, 0], embedded_data[indices, 1], label=f'{mapping[label]}', alpha=0.6)
...
ax2.legend()
plt.savefig('/home/xiao/code/CS5242/CS5242/pca.png', dpi=300, bbox_inches='tight')
plt.show()
